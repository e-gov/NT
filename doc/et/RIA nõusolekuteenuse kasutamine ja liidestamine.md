...
- [3. Põhiprotsesside kirjeldus kasutusjuhtudena](#põhiprotsesside-kirjeldus-kasutusjuhtudena)
  ...
  - [3.2 Kasutusjuht 1.1: Kliendirakendus valideerib Andmesubjekti nõusoleku(d) ja suunab Andmesubjekti esindaja Andmesubjekti puudolevaid nõusolekuid andma](#kasutusjuht-11-kliendirakendus-valideerib-andmesubjekti-nõusolekud-ja-suunab-andmesubjekti-esindaja-andmesubjekti-puudolevaid-nõusolekuid-andma)
  - [3.3 Kasutusjuht 2: Andmete pärimine ja nõusoleku valideerimine (andmekogu)](#kasutusjuht-2-andmete-pärimine-ja-nõusoleku-valideerimine-andmekogu)
...
- [6. Juhised andmenõusolekuteenuse testimiseks liidestuja poolt](#juhised-andmenõusolekuteenuse-testimiseks-liidestuja-poolt)
  ...
  - [6.2 Nõusoleku andmine (_approve_) ja keeldumine/tagasivõtmine (_decline_)](#nõusoleku-andmine-approve-ja-keelduminetagasivõtmine-decline)
  ...
  - [6.5 Nõusolekute alusel edukast andmete pärimisest raporteerimine (Andmekogu)](#nõusolekute-alusel-edukast-andmete-pärimisest-raporteerimine-andmekogu)
...
- [10. Andmenõusolekuteenuse kasutajaliides](#andmenõusolekuteenuse-kasutajaliides)
  ...
  - [10.2 Nõusolekute haldus](#nõusolekute-haldus)
    ...
    - [10.2.2 Minu nõusolekud](#minu-nõusolekud)
      - [10.2.2.1 Nõusolekust loobumine](#nõusolekust-loobumine)
      - [10.2.2.2 Nõusoleku pikendamine](#nõusoleku-pikendamine)
...
- Klientrakendus pakub Andmesubjektile soovitud teenuse ja selle
  ...
  (andmekogu)" (vt. jaotis [3.2](#kasutusjuht-2-andmete-pärimine-ja-nõusoleku-valideerimine-andmekogu).).
...
2.  Klientrakendus kontrollib Andmenõusolekuteenuse abil, kas teenuse
    ...
    nõusolekud. Kasutatakse **_getConsentReferences_** ja/või
    **_validateConsentForClient_** päringuid (vt jaotised
...
3.  Klientrakendus küsib Andmenõusolekuteenuselt lingi, mis suunaks
    ...
    Kasutatakse **_getConsentGroupReferenceRepresentable_** päringut (vt
...
2.  Andmekogu saadab nõusolekuviite Andmenõusolekuteenusesse valideerimiseks.
    ...
    **_validateConsentForDataProvider_** päringut (vt jaotis
...
5.  Andmekogu raporteerib eduka andmeedastuse. Kasutatakse
    **_reportDataTransmission_** päringut (vt jaotis
...
![Põhistsenaariumi jadadiagramm](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image2.png)
...
![Nõusoleku seisundidiagramm](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image3.png)
...
nõusolekuviited (_Consent Reference_).
...
_Testijuhtum 1 Nõusoleku URLi genereerimine ning nõusoleku info
vaatamine (1 eesmärgideklaratsioon)_
...
_Testijuhtum 2 Nõusoleku URLi genereerimine ning nõusoleku info vaatamine (mitu eesmärgideklaratsiooni – test läbida juhul, kui sellise stsenaariumid jaoks on olemas sisuline vajadus)_
...
_Testijuhtum 3 Nõusoleku URLi genereerimine, kui antud isikukoodi, ED ning X-Tee alamsüsteemi jaoks on juba olemas nõusolekutaotlus või nõusolek (erinevates staatustes)_
...
_Testijuhtum 10 Nõusolekute valideerimine (Klientrakenduse ja Andmekogu
jaoks)_
...
_Testijuhtum 11 Nõusolekute alusel andmete pärimisest raporteerimine
(raporteerib andmekogu)_
...
![Teenusedeklaratsiooni seisundidiagramm](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image12.png)
...
![Eesmärgideklaratsiooni seisundidiagramm](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image17.png)
...
kasutades teenust **_getConsentGroupReference_**
API (vt jaotis [5.1.1](#getconsentgroupreference)), kui Andmesubjekti esindaja, siis kasutatakse
teenust **_getConsentGroupReferenceRepresentable_** (vt jaotist
...
![Nõusolekutaotlused](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/NT%20taotlus.PNG)
...
![Nõusoleku andja,andmete edastaja, andmete saaja](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/Infov%C3%A4ljad%20koos.PNG)
...
![Luban](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/NT%20taotlus%20luban.PNG)
...
![Ei luba](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/NT%20taotlus%20ei%20luba.PNG)
...
![Kinnitan](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/N%C3%B5usolek%20antud.PNG)
...
kehtivad. Kasutatakse **_getConsentReferences_** ja
**_validateConsentForClient_** API-d (vt jaotised [5.1.2.](#getconsentreferences) ja
...
uue lingi (kasutades **_getConsentGroupReference_** API
...
![Andmenõusolekuteenusest](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image26.jpeg)
...
![Minu nõusolekud](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image27.jpeg)
![Lapse nõusolekud](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image32.png)
...
![Nõusoleku detailid ja loobumine](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/N%C3%B5usolek%20portaalis.PNG)
...
![Esindaja kinnitas](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image33.png)
...
![Nõusoleku kehtivuse lõppemise põhjus](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image29.jpg)
...
![Loobu või pikenda](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image34.png)

Kui nõusolekust loobutakse, siis muudetakse nõusolek kehtetuks ja
kasutajale kuvatakse teadet „Nõusolek on tagasi võetud".

![Loobutud nõusolek](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image35.png)
...
![Pikendamine](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/NT%20pikendamine.PNG)
...
![Edastatud andmed](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image30.jpeg)
...
![Lapse edastatud andmed](../img/RIA%20n%C3%B5usolekuteenuse%20kasutamine%20ja%20liidestamine/image37.png)
