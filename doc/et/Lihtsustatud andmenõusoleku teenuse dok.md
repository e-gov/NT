...
| error.business.file-type-invalid                                  | FILE_TYPE_INVALID (400)                                  | Sisendis antud fileType väärtus ei ole lubatud (lubatud väärtused: CONSENT_CONTAINER, GENERATED_PDF)                                                                     |
