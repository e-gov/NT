...
| error.business.consent-signature-too-old                       | CONSENT_SIGNATURE_TOO_OLD (400)                       | The signature was created outside the allowed time window                                          |
| error.business.consent-signed-container-processing-failed      | CONSENT_SIGNED_CONTAINER_PROCESSING_FAILED (500)      | An unexpected error occurred while processing the container                                        |
